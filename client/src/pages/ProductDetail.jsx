            ...
            style={{
              ...
              <div className="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  ...
                  <p className="leading-relaxed text-white">{product.description}</p>
                    ...
                    {product.countInStock > 0 ? (
                      <div className="flex ml-6 items-center">
                        ...
                        <div className="relative">
                          ...
                          <span className="absolute right-0 top-0 h-full w-10 text-center text-gray-100 pointer-events-none flex items-center justify-center">
                            <svg
                              fill="none"
                              stroke="currentColor"
                              strokeLinecap="round"
...
<button className="rounded-full w-10 h-10 bg-gray-400 p-0 border-0 inline-flex items-center justify-center text-gray-100 ml-4 hover:bg-red-500 transition">
  <svg
    fill="currentColor"
    strokeLinecap="round"
    strokeLinejoin="round"
